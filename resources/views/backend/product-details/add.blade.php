...
@section('main')
    <section class="form-input" width="70%">
        <div class="card">
            <div class="card-header bg-white text-uppercase font-weight-bold">Thêm phiên bản sản phẩm</div>
            <div class="card-body">
                <form action="{{ route('admin.product-detail.store', request()->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-8">
                            ...
                            <input type="text" class="form-control" name="name" placeholder="Tên sản phẩm" value="{{ $product->name }}" disabled>
                        </div>
