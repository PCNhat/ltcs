...
<body>
        ...
        <div class="cover-menu-top">
            ...
            <div class="float-right menu">
                <ul>
                    ...
                    <li class="float-right"><a href="https://www.youtube.com/channel/UC5CIt5W4kq4ie0KJEdg2ztg">Fan page</a></li>
    ...
    <footer>
        <div class="container">
            <div class="row">
                <div class="col-md-3">
                    <div class="footer-title">Theo dõi Blog</div>
                ...
                <div class="col-md-3">
                    <div class="footer-title">Blog bạn bè</div>
                    <ul class="footer-menu">
