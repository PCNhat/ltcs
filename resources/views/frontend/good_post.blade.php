...
@section('title','Bài viết hay')
@section('main')
<article id="good-post">
    <div class="container container-fix">
        <h1 class="title-post">Tổng hợp các bài viết hay trên Blog Lập Trình Cuộc Sống</h1>
        <div class="body-post">                
            <p>Để các bạn tiện theo dõi, tại trang này sẽ cập nhật các bài viết được bạn đọc quan tâm nhất, cũng như mình cảm thấy có ích cho người đọc nhất.</p>
            ...
            <p><a href="">Giải thích và hướng dẫn cài đặt Gitlab Continuous Deployment một cách dễ hiểu nhất</a></p>
            ...
            <p><a href="">Tôi đã hack Chợ Tốt như thế nào</a></p>
            <p><a href="">Những phần mềm nên cài đặt trên ubuntu</a></p>
            <p><a href="">Tổng hợp tất tần tật những công cụ cần thiết cho web developer</a></p>
            <p>Ngoài ra, để có thể nhận được bài viết sớm nhất, bạn có thể click vào đây để đăng ký, khi có bài viết mới, bạn sẽ nhận được nó qua email. Hoặc theo dõi <a href="">fanpage</a> hoặc <a href="">kênh youtube</a> của Lập trình cuộc sống.</p>
        </div>
    </div>
</article>
@stop